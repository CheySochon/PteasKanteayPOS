...
export default function AdminKitchenPage() {
  ...
  return (
    <div className={`flex-1 overflow-y-auto flex flex-col ${dark ? "bg-[#181920] text-slate-100" : "bg-white text-slate-800"}`}>
      <TopBar
      ...
      <main className="p-4 sm:p-6 space-y-5 flex-1">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-1">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-[#0F522B]/10 dark:bg-emerald-500/20 text-[#0F522B] dark:text-emerald-400 flex items-center justify-center font-bold">
              <ChefHat size={22} />
            </div>
            <div>
              <h2 className="text-xl font-normal text-slate-800 dark:text-white shrink-0">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <button
              type="button"
              onClick={loadOrders}
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 text-xs font-semibold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors cursor-pointer"
            >
        ...
        {kitchenOrders.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center bg-white dark:bg-[#232333] rounded-2xl border border-slate-200/80 dark:border-slate-800">
            <div className="h-14 w-14 rounded-full bg-emerald-50 dark:bg-emerald-950/40 text-[#0F522B] dark:text-emerald-400 flex items-center justify-center mb-3">
